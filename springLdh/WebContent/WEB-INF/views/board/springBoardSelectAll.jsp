...
<link rel="stylesheet" href="/springLdh/common/datepiker/jquery-ui-1.12.1/jquery-ui.min.css">
<script src="https://code.jquery.com/jquery-1.12.4.js"></script>
<script src="/springLdh/common/datepiker/jquery-ui-1.12.1/jquery-ui.min.js"></script>
		...
		*/
		...
		$(document).on("click", "#searchBtn", function(){
			...
			$("#boardList").attr({ "method":"GET"
				                  ,"action":"boardSelectAll.ldh"}).submit();
		});
		...
		$("#startdate").datepicker({		
			...
			buttonImage: "/springLdh/img/cal_0.gif", 
...
<%
for(int i=0; i<nCnt; i++){		 //nCnt갯수에 따라서 for문으로 전체입력 출력하기
...
<tr>
	...
	<td class="tt"><%= bvo.getSbnum() %> </td> <!-- jsp출력 -->
	...
	<td class="tt"><img src="/springLdh/fileupload/board/sm_<%= bvo.getSbfile() %>"> </td>	
</tr>	
<%
}//end of for
%>						
