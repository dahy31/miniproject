	...
	$(document).ready(function(){
		...
		*/
		...
		function ajaxIdCheckData(myval){
			...
			//controller에 memIdCheck value 매핑
			let idCheckURL = "memIdCheck.ldh";
			let reqType = "POST";
		...
		*/
			...
			console.log("mpw >>> : " + document.memForm.mpw)
			...
			*/	
			...
			console.log("mhp2 >>> : " + $('input[name=mph2]').val());
			...
			//이메일
			console.log("memail >>> : " + $('input[name=memail1]').val());
